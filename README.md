# auto-patch [![Build Status](https://secure.travis-ci.org/bflad/chef-auto-patch.png?branch=master)](http://travis-ci.org/bflad/chef-auto-patch)
...
This repo includes a .kitchen.yml file which leverages [Test Kitchen](http://kitchen.ci/) and [Vagrant](http://docs.vagrantup.com/v2/cli/index.html) to test and verify.  

Test Kitchen is already included as part of [ChefDK](https://downloads.chef.io/chef-dk/).  To start testing run:
