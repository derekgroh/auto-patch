...
default['auto-patch']['monthly'] = 'third wednesday'
default['auto-patch']['once'] = true
default['auto-patch']['month'] = 4
...
default['auto-patch']['prep']['monthly'] = 'third wednesday'
default['auto-patch']['prep']['splay'] = 0
